...
local comPower = StaticObject.getByName('com-power')
redIADS:addCommandCenter(commandCenter):addPowerSource(comPower)

redIADS:addRadioMenu()

redIADS:setupSAMSitesAndThenActivate(120)
...
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Anapa")
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Krasnodar")
...
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Tbilisi")
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Beslan")
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Novorossiysk")
A2ADispatcher:SetSquadronTakeoffFromParkingHot("Mineralnye")

A2ADispatcher:SetSquadronTakeoffFromRunway("MozdokGci")
A2ADispatcher:SetSquadronTakeoffFromRunway("MaykopGci")
A2ADispatcher:SetSquadronTakeoffFromRunway("MineralnyeGci")
A2ADispatcher:SetSquadronTakeoffFromRunway("NovorossiyskGci")
...
A2ADispatcher:SetSquadronLandingNearAirbase("MozdokGci")
A2ADispatcher:SetSquadronLandingNearAirbase("MaykopGci")
A2ADispatcher:SetSquadronLandingNearAirbase("MineralnyeGci")
A2ADispatcher:SetSquadronLandingNearAirbase("NovorossiyskGci")
...
A2ADispatcher:SetTacticalDisplay(false) --DEBUG
